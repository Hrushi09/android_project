...
public class Hotel5details extends AppCompatActivity {
    private Button Reserve5;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hotel5details);
        getSupportActionBar().setTitle("RentoGo");
       

        Reserve5 = (Button) findViewById(R.id.reserve5);
        ...
        Reserve5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("h5", "h55");
                editor.commit();
                startActivity(new Intent( Hotel5details.this, thankyou.class));
            }
        });
    }
    @Override
